...
class InventaryEController extends Controller
{
    ...
    {
        $inventarioE = InventaryE::with('order', 'order.user', 'order.orderStatus', 'orderDetail', 'orderDetail.address', 'orderDetail.producto', 'orderDetail.typePay')->whereHas('order', function (Builder $query) {
